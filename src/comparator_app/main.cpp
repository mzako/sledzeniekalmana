...
void start_compare(std::shared_ptr<comparator_module> comparator_module_, std::shared_ptr<blocking_queue> generator_queue, std::shared_ptr<blocking_queue> filter_queue) {
