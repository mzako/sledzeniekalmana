...
public:
     ...
     */
    void init_targets(std::vector<std::pair<int, commons::vect3f>> positions,
            std::vector<commons::sensor_parameters_dto> sensor_parameters);
    /**
     ...
     */
    template<class T>
    boost::numeric::ublas::matrix<T> invert_matrix(
            boost::numeric::ublas::matrix<T>& input);
    /**
